...
<form class="form-horizontal" id="form-norm" method="post">
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <input type="text" name="dorucovaci_ulice" class="form-control" placeholder="Ulice" required>
            <input type="text" name="dorucovaci_cp" class="form-control" placeholder="Číslo popisné" required>
            <input type="text" name="dorucovaci_mesto" class="form-control" placeholder="Město" required>
            <input type="text" name="dorucovaci_psc" class="form-control" placeholder="PSČ" required>
